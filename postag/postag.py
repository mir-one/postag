# -*- coding: utf-8 -*-
"""
Модель частеречной разметки для русскоязычных текстов (проект https://github.com/mir-one/postag)
небольшой баг с нормализацией (замена "ё" на "е") перед поиском в грамматическом словаре
"""
...
class postag(object):
    ...
    def load(self, word2tags_path=None):
        ...
        config_path = os.path.join(data_folder, 'postag.config')
        ...
        model_path = os.path.join(data_folder, 'postag.model')
